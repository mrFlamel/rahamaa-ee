...
var s_sitecatalyst=s_gi(s_account);

function clearSCParam()
{
 s_sitecatalyst.campaign = "";
 s_sitecatalyst.eVar1 = "";
 s_sitecatalyst.eVar2 = "";
 s_sitecatalyst.eVar3 = "";
 s_sitecatalyst.eVar20 = "";
 s_sitecatalyst.eVar21 = "";
 s_sitecatalyst.eVar22 = "";
 s_sitecatalyst.eVar23 = "";
 s_sitecatalyst.prop9 = "";
 s_sitecatalyst.prop10 = "";
 s_sitecatalyst.prop11 = "";
 s_sitecatalyst.prop12 = "";
 s_sitecatalyst.prop13 = "";
 s_sitecatalyst.prop14 = "";
 s_sitecatalyst.prop20 = "";
 s_sitecatalyst.prop21 = "";
 s_sitecatalyst.prop22 = "";
 s_sitecatalyst.prop23 = "";
 s_sitecatalyst.events = ""; 
 s_sitecatalyst.products = "";
}

/* Timestamp (DD-MM-YYYY HH:MM:SS) */
function sctimestamp()
{
...
var sfinaltime=""+h+":"+m+":"+s;
var sctimestamp=""+dd+"-"+mm+"-"+yyyy+" "+ sfinaltime;
return(sctimestamp);
}

/* Rich media tracking function */
function flashEventFunction(scpagename,scevent,sclinkurl,sctarget){
 var res=s_sitecatalyst.pageName;
 s_sitecatalyst.pageName="Rich Media: "+scpagename;
 s_sitecatalyst.prop45 = sctimestamp();  
 clearSCParam();
 if (scevent == "o")
 	{
	s_sitecatalyst.events="purchase,event1";
	s_sitecatalyst.products=";"+s_sitecatalyst.pageName+";;;";
	s_sitecatalyst.prop11 = s_sitecatalyst.pageName;
	}
 else if (scevent == "l")
 	{
	s_sitecatalyst.events="event2";
	s_sitecatalyst.products=";"+s_sitecatalyst.pageName+";;;";
	s_sitecatalyst.prop12 = s_sitecatalyst.pageName; 
	s_sitecatalyst.prop45 = sctimestamp();  
	}
 else if(scevent == "m")
 	{
	s_sitecatalyst.events="event6";
	s_sitecatalyst.products=";"+s_sitecatalyst.pageName+";;;";
	}
 else if(scevent == "p")
 	{
	s_sitecatalyst.events="prodView";
	s_sitecatalyst.products=";"+s_sitecatalyst.pageName+";;;";
	s_sitecatalyst.eVar1=s_sitecatalyst.pageName;
	}
 s_code=s_sitecatalyst.t();
 s_sitecatalyst.pageName=res;
 
 if (sclinkurl != null && sclinkurl != "")
 	{
	if (sctarget != "_blank")
		{
		location.href=sclinkurl;	
		}
	else
		{
		window.open(sclinkurl);
		}
	} 	
}

/* CookieDomain TLD correction */
if (document.location.host.toLowerCase().match("co.uk")) s_sitecatalyst.cookieDomainPeriods="3";

/* OSS/OSP tracking function */
var ospArray = new Array("Show OSP Form - ","Approve OSP Form - ","Receipt OSP Form - ");

function tracker(ossPageEvent,ossProduct){
	clearSCParam();
   ossPagename = s_sitecatalyst.pageName;
   if (ossProduct != null)
   {
	ossPagename = ossPagename.replace(ossProduct, "");
	ossPagename = ossProduct + " " + ossPagename;
   }
   for (i=0;i<ospArray.length;i++){
   ossPagename = ossPagename.replace(ospArray[i], "");
   }
    if(ossPageEvent.substring(0,5)=="AnsNy"){ 
     ossPageLocation = ospArray[0]+ossPagename; 
     s_sitecatalyst.prop10 = ossPageLocation; 
     s_sitecatalyst.eVar2 = ossPageLocation; 
    }
    if(ossPageEvent.substring(0,10)=="AnsGodkend"){
     ossPageLocation = ospArray[1]+ossPagename; 
    }
    if(ossPageEvent.substring(0,9)=="AnsoegTak"){ 
     ossPageLocation = ospArray[2]+ossPagename; 
     s_sitecatalyst.events = "purchase,event1"; 
     s_sitecatalyst.products = ";"+ossPageLocation+";;;";
     s_sitecatalyst.prop11 = ossPageLocation; 
    }
  s_sitecatalyst.pageName=ossPageLocation;
  s_sitecatalyst.campaign = "";
  s_code=s_sitecatalyst.t();
}
...
function s_sitecatalyst_doPlugins(s_sitecatalyst) {
 var i=1;
 var output="";

 for (i=1;i<=6;i++)
 {
  if (s_getPathFromURL(i)!="" && s_getPathFromURL(i)!="pages"){
   output = output + s_getPathFromURL(i); 
   
    if(s_getPathFromURL(i+1)!="" && s_getPathFromURL(i+1)!="pages"){output = output +","}
  };

 }
 s_sitecatalyst.hier1=output;

 /*enable SC to TNT*/
 if (window.mboxLoadSCPlugin && typeof window.mboxLoadSCPlugin == "function") {
     mboxLoadSCPlugin(s_sitecatalyst);
 }
}

s_sitecatalyst.doPlugins=s_sitecatalyst_doPlugins
/************************** PLUGINS SECTION *************************/
 ...
 */
s_sitecatalyst.getQueryParam=new Function("p","d","u",""
+"var s=this,v='',i,t;d=d?d:'';u=u?u:(s.pageURL?s.pageURL:s.wd.locati"
+"on);if(u=='f')u=s.gtfs().location;while(p){i=p.indexOf(',');i=i<0?p"
+".length:i;t=s.p_gpv(p.substring(0,i),u+'');if(t)v+=v?d+t:t;p=p.subs"
+"tring(i==p.length?i:i+1)}return v");
s_sitecatalyst.p_gpv=new Function("k","u",""
+"var s=this,v='',i=u.indexOf('?'),q;if(k&&i>-1){q=u.substring(i+1);v"
+"=s.pt(q,'&','p_gvf',k)}return v");
s_sitecatalyst.p_gvf=new Function("t","k",""
+"if(t){var s=this,i=t.indexOf('='),p=i<0?t:t.substring(0,i),v=i<0?'T"
+"rue':t.substring(i+1);if(p.toLowerCase()==k.toLowerCase())return s."
+"epa(v)}return ''");


/* Custom getQueryParam function */
function dbgGetSearchParam(){
Params={};
var dbsearchstring=window.location.search.substr(1);
if (dbsearchstring!='') {
		dbsearchstring = dbsearchstring.replace("%3F","?"); 
		dbsearchstring = dbsearchstring.replace(/%3D/g,"=");
		dbsearchstring = dbsearchstring.replace(/%26/g,"&");
		dbsearchstring = dbsearchstring.replace("&amp;", "&");
		dbsearchstring = dbsearchstring.replace("%7c;", "|");
var pairs=dbsearchstring.split('&');
...
function dbgGetQueryParam(getParam){
var allParam = dbgGetSearchParam();
var singleParam = allParam[getParam];
singleParam = decodeURIComponent(singleParam);
if (singleParam=='undefined') singleParam="";
return singleParam;
}


/* Automatic Campaign Segmentation */
s_sitecatalyst.campaign = dbgGetQueryParam('sc_cid');
var autoCampaign = dbgGetQueryParam('sc_cid');
if (autoCampaign.indexOf("|") != -1){
	autoCampaignArray = autoCampaign.split("|");
	s_sitecatalyst.campaign = "Campaign: " + autoCampaignArray[0];;
	s_sitecatalyst.eVar20 = autoCampaign; 	      //Trackingkode
	s_sitecatalyst.eVar21 = autoCampaignArray[0]; //Campaign
	s_sitecatalyst.eVar22 = autoCampaignArray[0] + " " + autoCampaignArray[1]; //Media
	s_sitecatalyst.eVar23 = autoCampaignArray[0] + " " + autoCampaignArray[1] + " " + autoCampaignArray[2] + " " + autoCampaignArray[3]; //Creative Element
	s_sitecatalyst.prop21 = autoCampaignArray[0]; //Campaign
	s_sitecatalyst.prop22 = autoCampaignArray[0] + " " + autoCampaignArray[1]; //Media
	s_sitecatalyst.prop23 = autoCampaignArray[0] + " " + autoCampaignArray[1] + " " + autoCampaignArray[2] + " " + autoCampaignArray[3]; //Creative Element
}

/* MCT */
var mctId = dbgGetQueryParam('mct_id');
if (mctId.indexOf("|") != -1){
	mctIdArray = mctId.split("|");
	s_sitecatalyst.campaign = "MCT: " + mctIdArray[0];;
	s_sitecatalyst.eVar30 = mctId; 	      //Full MCT ID
	s_sitecatalyst.eVar31 = mctIdArray[0]; //Communication_ID
	s_sitecatalyst.eVar32 = mctIdArray[0] + " " + mctIdArray[1]; //Date
	s_sitecatalyst.eVar33 = mctIdArray[0] + " " + mctIdArray[2]; //Resptracking_CD
	s_sitecatalyst.eVar34 = mctIdArray[0] + " " + mctIdArray[3]; //MKT_ID
	s_sitecatalyst.eVar35 = mctIdArray[0] + " " + mctIdArray[4]; //Link_Type
	s_sitecatalyst.prop30 = mctId; 	      //Full MCT ID
	s_sitecatalyst.prop31 = mctIdArray[0]; //Communication_ID
	s_sitecatalyst.prop32 = mctIdArray[0] + " " + mctIdArray[1]; //Date
	s_sitecatalyst.prop33 = mctIdArray[0] + " " + mctIdArray[2]; //Resptracking_CD
	s_sitecatalyst.prop34 = mctIdArray[0] + " " + mctIdArray[3]; //MKT_ID
	s_sitecatalyst.prop35 = mctIdArray[0] + " " + mctIdArray[4]; //Link_Type
	if (mctIdArray[4].indexOf("CTA") == 0)
	{
		s_sitecatalyst.events="event6";
		s_sitecatalyst.products=";MCT: "+s_sitecatalyst.pageName+";;;";
	}
	if (this.mctOptOutFunc){mctOptOutFunc();}
}


/* Custom link Tracking */
s_sitecatalyst.prop20 = dbgGetQueryParam('sc_clink');

/* WARNING: Changing any of the below variables will cause drastic
changes to how your visitor data is collected.  Changes should only be
made when instructed to do so by your account manager.*/
s_sitecatalyst.visitorNamespace="danskebank"
s_sitecatalyst.dc=112
