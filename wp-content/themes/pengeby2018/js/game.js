...
function endMonth() {
    ...
    if (gameConfig.currentEventPrice < 0) {
        gameConfig.eventContainer.addChild(createMonoRow("Kontojääk", 0, (totalAmount + (-1 * gameConfig.currentEventPrice)), xPos, yPos));
    } else {
        gameConfig.eventContainer.addChild(createMonoRow("Kontojääk", 0, (totalAmount - gameConfig.currentEventPrice), xPos, yPos));
    }
    yPos += 25;
    ...
    //subtotal
    gameConfig.eventContainer.addChild(createMonoRow("Kokku", 2, totalAmount, xPos, yPos));
    yPos += 50;
